---
name: bump-minor
description: Bump the application's minor version across manifests and lockfiles and commit (e.g., 0.1.0 to 0.2.0).
disable-model-invocation: true
---

Bump the minor version of this application.
...
3. Increment minor by 1 and reset patch to 0 (e.g., `0.1.0` -> `0.2.0`).
