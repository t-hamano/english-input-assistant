...
export function App() {
  ...
  useEffect(() => {
    const unlisten = [
      ...
      listen<{ request_id: number; result: TranslationResult; complete: boolean }>(
        "translation-update",
        (e) => {
      ...
      getCurrentWindow().listen("tts-playing", () => {
        setPlaying(true);
        setAudioError(null);
      }),
    ...
    <div id="popup">
      <div className="drag-handle" data-tauri-drag-region>
        <span className="popup-title">
          ...
          {view.type === "result" ? "：翻訳結果" : view.type === "error" ? "：エラー" : "：翻訳中"}
        </span>
      </div>
      <button type="button" className="popup-close" title="閉じる" onClick={handleClose}>
        &#x2715;
      </button>
      {view.type === "loading" && (
        ...
        <div className="content">
          ...
          <div className="buttons">
            <button
              ...
              onClick={handleRetry}
              disabled={translation.requestId === null}
            >
              再試行
            </button>
